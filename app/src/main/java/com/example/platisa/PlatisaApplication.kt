...
import com.example.platisa.core.worker.StornoCleanupScheduler
...
class PlatisaApplication : Application(), Configuration.Provider {
    ...
    private fun scheduleSync() {
        ...
        val startSync = androidx.work.OneTimeWorkRequestBuilder<com.example.platisa.core.worker.GmailSyncWorker>()
            .setConstraints(
        ...
        val dailySync = androidx.work.PeriodicWorkRequestBuilder<com.example.platisa.core.worker.GmailSyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)
