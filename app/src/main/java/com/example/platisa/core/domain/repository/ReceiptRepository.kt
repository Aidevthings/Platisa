...
interface ReceiptRepository {
    ...
    // Items
    suspend fun insertReceiptItems(items: List<com.example.platisa.core.domain.model.ReceiptItem>, receiptId: Long)
    suspend fun getReceiptItems(receiptId: Long): List<com.example.platisa.core.domain.model.ReceiptItem>
