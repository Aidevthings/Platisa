...
data class ParsedReceipt(
    ...
    val items: List<com.example.platisa.core.domain.model.ReceiptItem> = emptyList(),
...
object ReceiptParser {
    ...
    private fun extractItems(text: String): List<com.example.platisa.core.domain.model.ReceiptItem> {
        val items = mutableListOf<com.example.platisa.core.domain.model.ReceiptItem>()
                    ...
                    if (price != null && qty != null && total != null) {
                        ...
                        if (diff.toDouble() < 1.0) {
                            ...
                            if (name.isNotEmpty() && !name.contains("------") && !name.uppercase().contains("UKUPNO")) {
                                items.add(com.example.platisa.core.domain.model.ReceiptItem(
                ...
                try {
                    ...
                    if (price != null && qty != null && total != null) {
                        ...
                        if (diff.toDouble() < 1.0) {
                            var name = line.substring(0, matcher.start()).trim()
                             if (name.isEmpty() || name.length < 3) {
                                if (i > 0) items.add(com.example.platisa.core.domain.model.ReceiptItem(
