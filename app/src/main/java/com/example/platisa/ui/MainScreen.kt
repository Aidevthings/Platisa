package com.example.platisa.ui
...
import com.example.platisa.ui.navigation.PlatisaNavHost
import com.example.platisa.ui.navigation.Screen
import com.example.platisa.ui.theme.LocalPlatisaColors
import com.example.platisa.ui.theme.PlatisaCustomColors
...
fun MainScreen() {
    ...
    // Tutorial state
    val showTutorial by com.example.platisa.ui.screens.help.TutorialState.showTutorial.collectAsState()
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        if (showTutorial) {
            com.example.platisa.ui.screens.help.TutorialOverlay(
                onDismiss = { com.example.platisa.ui.screens.help.TutorialState.dismiss() }
            )
        }
    }
}
