...
object QrCodeExtractor {
    ...
    // ML Kit scanner - lazy initialization to prevent startup leaks
        ...
        return try {
                        ...
                        try {
                            ...
                            for (maxDim in listOf(256, 400, 512, 800)) {
                                ...
                                try {
                                    ...
                                    val resultValue = barcodes.firstOrNull()?.rawValue
                                    if (resultValue != null) {
            ...
            try {
                ...
                if (bitmap.height > bitmap.width * 1.2) {
                    ...
                    val cropped = cropBottomHalf(bitmap)
                ...
                for (rotation in listOf(0, 90, 180, 270)) {
                    ...
                    val textValue = barcodes.firstOrNull { it.format in ACCEPTED_FORMATS }?.rawValue
                    if (textValue != null) {
