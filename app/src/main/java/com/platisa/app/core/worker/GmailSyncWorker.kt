...
import com.platisa.app.core.domain.usecase.SyncReceiptsUseCase
...
class GmailSyncWorker @AssistedInject constructor(
    ...
    private val platisaNotificationManager: com.platisa.app.core.notification.PlatisaNotificationManager,
    ...
    private fun showSuccessNotification(downloaded: Int, parsed: Int) {
        ...
        val intent = android.content.Intent(applicationContext, Class.forName("com.platisa.app.MainActivity")).apply {
